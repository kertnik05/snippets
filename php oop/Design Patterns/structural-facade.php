 ...
 */
//The Class to which the object will be created
class Book {
    private $author;
    private $title;
...
//Accessed CaseReverseFacade's reverseStringCase 
//This is analogous to a driver pressing the break in which it is connected to inner workings
