...
/**
 * Reference: http://www.jakowicz.com/builder-pattern-in-php/
 * The goal is to create an object, pre-set some of its attributes, inject dependencies and other general object setup
 */
...
class HTMLPageDirector extends AbstractPageDirector {
  ...
  //Start the HTMLPageDirector
  $pageDirector = new HTMLPageDirector($pageBuilder);
  //Start the Building The page
