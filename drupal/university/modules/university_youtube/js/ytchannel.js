...
(function($) {
  Drupal.behaviors.dsYtChannel = {
    attach: function(context, settings) {
    	/*url to get youtube deatails*/
      $.getJSON('http://gdata.youtube.com/feeds/users/' + settings.dsYtChannel.channelName + '/uploads?alt=json&format=1&callback=?', null, function(data) {
  ...
  Drupal.theme.prototype.ytChannelAuthor = function(submitted) {
    ...
    if (submitted.hits > 0)
      $out += '<span class="yt-hits">' + submitted.hits + ' views</span>';
