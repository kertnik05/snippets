...
<div id="<?php print $block_html_id; ?>" class="social_details instagram"<?php print $attributes; ?>>
 <div class="heading">
                            <img src="<?php print $themepath; ?>/images/insta_big.png" alt="" />
                           <p><a href="http://instagram.com/<?php print  $user_name; ?>" target="_blank">Follow our Instagram</a></p>
