...
<div id="<?php print $block_html_id; ?>" class="social_details youtube"<?php print $attributes; ?>>
 <div class="heading">
                            <img src="<?php print $themepath; ?>/images/youtube_big.png" alt="" />
                            <p><a href="https://www.youtube.com/user/<?php print  $channel; ?>" target="_blank">Visit us on Youtube</a></p>
                        </div>
                        <div class="heading _second">
                            <a><img src="<?php print $themepath; ?>/images/howard_social_logo.png" alt="" /></a>
                            <p>Recent video from HowardU</p>
                        </div>
