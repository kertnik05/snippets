		...
		<div class="main_top_section <?php print($socialShareClass.' '.$stripedBG); ?>">
			<div class="inner_content">
				...
				if(empty($hidePageTitle) || $hidePageTitle == 0): ?>
					<div class="row">
                    	<div class="col-xs-12">
                        	<h1 class="title" id="page-title"> <?php print 'PAGE NOT FOUND'; ?> </h1>
                        </div>
                    </div>
				<?php endif;
                        ...
                        <div class="main-content col-xs-12">
                          <div class="region region-content">
    												<div id="block-system-main" class="block block-system">
															<div class="content">
																<p>The page you were trying to access has been moved or no longer exists. Please visit the <strong><?php print l('Homepage');?></strong> to find information.</p>
                                 <p>If you need additional assistance in searching for answers, <strong><?php print l('contact us', 'contact' );?></strong> and we will be happy to assist.
																</p>
														  </div>
														</div>
													</div>
