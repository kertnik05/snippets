/* ui.bootstrap install the angular bootstrap module as a dependency */
var cats_slider = angular.module('cats_slider', ['ui.bootstrap.carousel']);
...
jQuery(document).ready(function() {
   ...
   */
  /*cats-app is located inside your html template all-cats.tpl.php */
  angular.bootstrap(document.getElementById('cats-slider-app'),['cats_slider']);
});
  /*catsController is located inside your html template all-cats.tpl.php */
 /* $http query json enpoints */
cats_slider.controller('catsCarouselController', function ($scope, $http) {
